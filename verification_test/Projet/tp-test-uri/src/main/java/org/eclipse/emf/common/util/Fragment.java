...
final class Fragment extends URI {
    ...
    public int hashCode() {
        ...
        //
        if (hashCode == 0) {
            hashCode = (uri.hashCode * 31 + URI_CONST.FRAGMENT_SEPARATOR) * CommonUtil.powerOf31(fragment.length()) + fragment.hashCode();
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof org.eclipse.emf.common.util.Fragment)) {
            return false;
        }

        // Be careful to accommodate the case of a deferred split interned fragment.
        //
        org.eclipse.emf.common.util.Fragment that = (org.eclipse.emf.common.util.Fragment) object;
